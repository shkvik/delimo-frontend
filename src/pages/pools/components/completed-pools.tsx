...
export const CompletedPools = () => {
  const completedPoolsData = [
    ...
    },
    {
      ...
      participants: 15,
      avatars: [
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=771",
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=772",
      ],
      additionalCount: 8,
    },
    {
    ...
    },
    {
      ...
      participants: 25,
      avatars: [
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=551",
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=552",
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=553",
      ],
      additionalCount: 20,
    },
    {
      title: "Благотворительность детям",
      status: "completed" as const,
      date: "15 дек 2024",
      collected: 18500,
      target: 15000,
      ...
      participants: 32,
      avatars: [
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=441",
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=442",
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=443",
      ],
      additionalCount: 15,
    },
    {
      ...
      participants: 6,
      avatars: [
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=331",
        "https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=332",
